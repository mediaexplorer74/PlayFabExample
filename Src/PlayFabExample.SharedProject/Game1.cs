...
namespace PlayFabExample
{
	...
	public class Game1 : Game
	{
		...
		public Game1()
		{
			...
			graphics.PreferredBackBufferWidth = 800;//480;
			graphics.PreferredBackBufferHeight = 640;// 800;
		...
		protected override void Initialize()
		{
			...
			var playFabClient = new PlayFabClient("144"); // enter your playhub project id here
		...
		protected override void LoadContent()
		{
			...
			{
				Debug.WriteLine("[ex] LoadTestFont error: " + ex.Message);
				throw;
			}
